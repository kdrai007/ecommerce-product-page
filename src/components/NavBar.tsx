    ...
    <nav>
      <div className="flex flex-row justify-between p-4 md:px-[100px]  relative ">
        <div className="flex flex-row items-center  gap-x-5 relative">
          ...
          <ul className="hidden gap-4 text-pGray ml-3 md:flex ">
            <li className='setLine hover:after:w-full addedClass '>Collections</li>
            <li className='setLine hover:after:w-full addedClass '>Men</li>
            <li className='setLine hover:after:w-full addedClass '>Women</li>
            <li className='setLine hover:after:w-full addedClass '>About</li>
            <li className='setLine hover:after:w-full addedClass'>Contact</li>
          </ul>
        </div>
        {!menu && <Menu />}
        {cart && <Cart />}
